    ...
    <v-card class="pa-6" min-width="400">
      ...
      <v-card-text>
        ...
        <v-form @submit.prevent="handleSignup" ref="form" v-model="valid">
          <v-text-field :rules="[rules.required, rules.name]" label="Name" v-model="name"
            prepend-inner-icon="mdi-account"></v-text-field>

          <v-text-field :rules="[rules.required, rules.email]" label="Email" v-model="email" type="email"
          ...
          <v-text-field :rules="[rules.required, rules.pw]" label="Password" v-model="password" type="password"
            prepend-inner-icon="mdi-lock" />

          <v-text-field :rules="[rules.required, rules.match]" label="Confirm Password" v-model="confirmPassword"
